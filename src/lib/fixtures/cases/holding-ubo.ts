 ...
 * de bénéficiaire effectif et un écart registre/capital.
 *
...
export const holdingUboBundle: CaseBundle = {
  ...
  edges: [
    ...
    // Capital de OPTIMA HOLDING (h1).
    { id: "u3", type: "DETIENT", source: "pa", target: "h1", weight: "60 %", label: "détient 60 %", evidenceLevel: "declared" },
    ...
    // Capital de BENALI INVEST (hb) — détention fragmentée (preuve plus faible).
    { id: "u7", type: "DETIENT", source: "pc", target: "hb", weight: "51 %", label: "détient 51 %", evidenceLevel: "declared" },
    { id: "u8", type: "DETIENT", source: "pb", target: "hb", weight: "49 %", label: "détient 49 %", evidenceLevel: "inferred", excerpt: "Détention déduite d'indices concordants — à confirmer." },
    // Gouvernance (pour contexte graphe).
